-- Задача 3
-- Есть таблица сообщений от мессенджера
--
...
--
-- Иногда мессенджер присвлает нам одно и то же сообщение несколько раз из-за сетевых проблем.
-- Как видно, мы сохраняем дубли при таких доставках;
